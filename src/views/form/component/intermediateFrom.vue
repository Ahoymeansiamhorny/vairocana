...
>
    <el-form ref="ruleFormRef" style="max-width: 600px; padding: 0 15px; margin: 0 auto" :model="personalForm"
      label-width="auto" class="demo-ruleForm" :size="formSize" status-icon :disabled="drawerProps.title === 'view'"
>
      ...
      <el-form-item label="手機">
        <el-input v-model="personalForm.mobile" />
      </el-form-item>
  ...
  <el-form-item label="禪友緊急聯絡人電話">
    <el-input v-model="personalForm.emergencyContactReferrerPhone" />
  </el-form-item>
      ...
      <el-form-item class="center">
        <el-button v-if="drawerProps.title === 'create'" type="primary" style="margin: 0 auto"
          @click="submitForm"
>建立</el-button>

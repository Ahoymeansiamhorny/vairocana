export default {
  validation: {
    ...
    PASSWORD_ACCOUNT_CANNOT_BE_SAME: '帳號密碼不能相同',
    EMAIL: '必須是有效的電子郵件',
    IS_PHONE: '必須是有效的電話號碼',
    ...
    PASSWORD_NEW_PASSWORD_CANNOT_BE_SAME: '新密碼不得與舊密碼相同',
  ...
  common: {
    ...
    PurchasesInformation: '購買資訊',
    CustomerInformation: '顧客資訊',
    resetPassword: '密碼更改成功，請重新登入',
    success: '成功',
    warn: '警告',
    dialogDrawerClose: '尚未存檔，是否繼續？',
  ...
  form: {
    ...
    fields: {
      ...
      MAX_THIRD_PARTY_TRANSFER_LIMIT: '第三方轉帳金額限制',
    ...
    titles: {
      confirmCancel: '確認/取消',
      addNewCashSettlementConfirmation: '新增現金結算確認',
      changeNumberConfirmation: '更改號碼確認',
      refund: '退款',
      completed: '完成',
  ...
  menu: {
    ...
    agent: '代理',
    agentAccountManage: '代理帳戶管理',
    agentLoginLog: '代理登入日誌',
    member: '會員',
    memberList: '會員列表',
    memberLoginLog: '會員登入日誌',
    setting: '設定',
    settingList: '設定列表',
    purchase: '購買',
    report: '報告',
  ...
  permission: {
    ...
    managerLog: '管理員日誌',
    managerLoginLog: '管理員登入日誌',
    managerResetPassword: '重置管理員密碼',
    managerResetSecure: '重置管理員安全設定',
    managerUpdate: '更新管理員',
    numberCreate: '創建號碼',
    numberDelete: '刪除號碼',
    numberList: '號碼列表',

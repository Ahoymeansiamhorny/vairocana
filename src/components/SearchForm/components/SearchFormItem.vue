...
const placeholder = computed(() => {
  ...
  if (
    ...
    return {
      rangeSeparator: '-',
      startPlaceholder: t('form.placeholder.startTime'),
      endPlaceholder: t('form.placeholder.endTime')
    }
  }
  const placeholder =
    search?.props?.placeholder ??
    (search?.el?.includes('input') ? t('form.placeholder.enter') : t('form.placeholder.select'))
  return { placeholder }
})
